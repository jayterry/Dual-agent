...
def test_review_request_without_artifact_directly_returns_ask_user() -> None:
    ctx = SkillContext(user_input="")
    with patch("dual_agent.cai.plan_execute.invoke_planner", side_effect=AssertionError("should not call planner")):
